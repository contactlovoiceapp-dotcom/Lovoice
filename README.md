...
- **AssemblyAI** — automatic voice transcription (FR). Used to fill `voices.transcript` and `messages` transcripts. **Scheduled for ~Q3 2026 (Phase 9, ≈3 months post-MVP).**
- **Hive Moderation** — automatic audio + text moderation pipeline (see `docs/ARCHITECTURE.md` §4.3.b). **Scheduled for ~Q3 2026 (Phase 9, ≈3 months post-MVP).**
